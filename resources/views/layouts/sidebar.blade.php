    ...
    <div class="pt-3 pb-3 flex"
        ...
        <a href="/" class="flex items-center">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden" src="/images/logo/logo-dark.png" alt="Logo" width="120" />
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block" src="/images/logo/logo.png" alt="Logo" width="120" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="favicon.png" alt="Logo" width="32" height="32" />
        </a>
    </div>

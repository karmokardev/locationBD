...
<body x-data="{
    ...
    <main>
        <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
            <div class="flex h-auto w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                <!-- Form -->
                {{-- <div class="flex w-full flex-1 flex-col lg:w-1/2"> --}}
                <div class="flex flex-col w-full min-h-screen md:w-1/2 md:mr-auto">
                    <div class="mx-auto w-full max-w-md pt-5 pb-3">
                        <a href="{{ route('home') }}"
                ...
                <div
                    class="bg-brand-950 fixed right-0 hidden h-[100vh] w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
